    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="#" className={styles.textLink}>Ссылка на GitHub будет позже.</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/levisserena" className={styles.textLink}>Акчурин Лев</a>
            </p>
          </div>
        </aside>
      </div>
